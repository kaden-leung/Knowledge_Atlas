...
Call the LLM to synthesise the recommendation prose. Prompt the LLM with the structured outputs from S1–S6 and the topic's existing meta-review (from the topic page); ask it to produce:
