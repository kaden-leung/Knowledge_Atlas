...
**Companion files (this session)**:
  ...
  - `docs/CODEX_V7_LITE_BUILD_SPEC_2026-05-18.md` (build spec for Codex)
  - `docs/CODEX_SUBSTITUTION_SKILL_BUILD_SPEC_2026-05-18.md` (build spec for Codex + AG)
