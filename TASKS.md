...
| UJ-A1 | **Cook & Campbell content lifted to standalone markdown** | CW | Mirror of the wireframe Surface 7b content as `160sp/ka_validities_showcase_content_2026-05-18.md`. Single source of truth, same pattern as the VR-measurability page. Unblocked. |
| UJ-A4 | **Substitution-skill build-spec document for Codex** | CW | `docs/SUBSTITUTION_SKILL_SPEC_2026-05-18.md`. Fuller version of the §2 content in the design-response doc; includes data-schema sketch, refusal criteria, confidence-display design (with placeholder lines marked PANEL-INPUT-REQUIRED until UJ-F returns). Unblocked. |
| UJ-A5 | **V7-Lite build-spec document for Codex** | CW | `docs/V7_LITE_SPEC_2026-05-18.md`. Which V7 stages run synchronously, which queue; topic-similarity threshold calibration protocol; IV/DV extraction subset; new-topic-seed queue interface. Unblocked. |
