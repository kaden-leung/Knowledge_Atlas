...
- Evidence:
  - [Track 2/Task 3/search_runner.py](search_runner.py)
  - [Track 2/Task 3/Phase 2/search_runner.py](Phase 2/search_runner.py)
  - Query inputs: [Track 2/Task 3/inputs/query_results.json](inputs/query_results.json)
  - One-command verification: [Track 2/Task 3/GRADER_GUIDE.md](GRADER_GUIDE.md)
...
- Evidence:
  - Submission shim: [Track 2/Task 3/abstract_collector.py](abstract_collector.py)
  - Phase implementation: [Track 2/Task 3/Phase 4/abstract_collector.py](Phase 4/abstract_collector.py)
  - Fallback chain documented: [Track 2/Task 3/TRACK2_EVALUATION_REPORT.md](TRACK2_EVALUATION_REPORT.md#abstract-collection)
...
- Evidence:
  - Triager output: [Track 2/Task 3/triage_results.json](triage_results.json)
  - Triage code: [Track 2/Task 3/Phase 4/stage2b_triage_decision.py](Phase 4/stage2b_triage_decision.py)
...
- Evidence:
  - Dashboard: [Knowledge_Atlas/160sp/apps/ka_topic_proposer.html](ka_topic_proposer.html)
  - Regeneration script: [Track 2/Task 3/Phase 6/generate_prisma_report.py](Phase 6/generate_prisma_report.py)
...
- Evidence:
  - Summary report: [Track 2/Task 3/NULL_RESULTS_REPORT.md](NULL_RESULTS_REPORT.md)
  - Lifecycle verifier: [Track 2/Task 3/verify_track2_workflow.py](verify_track2_workflow.py)
...
- Answer: Both manual-review topics are documented and cross-linked below.
  - Manual review packet: [Track 2/Task 3/MANUAL_REVIEW_PACKET.md](MANUAL_REVIEW_PACKET.md)
  - `Null results + MISSING_ABSTRACT` evidence: [Track 2/Task 3/NULL_RESULTS_REPORT.md](NULL_RESULTS_REPORT.md)
  - `Verification questions` / failure analysis: [Track 2/Task 3/FAILURE_ANALYSIS.md](FAILURE_ANALYSIS.md) and [Track 2/Task 3/TRACK2_EVALUATION_REPORT.md](TRACK2_EVALUATION_REPORT.md)
...
See also: [Track 2/Task 3/NULL_RESULTS_REPORT.md](NULL_RESULTS_REPORT.md) (detailed breakdown)
