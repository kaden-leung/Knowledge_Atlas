...
A gap-driven pipeline that turns CNFA knowledge gaps (Task 2) into targeted queries, retrieves and triages candidate papers, attempts PDF acquisition, and hands accepted papers to a downstream validator. Phases 2–7, 185/185 unit tests, end-to-end chain verifier.
...
4. [MANIFEST.md](MANIFEST.md) — full audit trail and the authoritative-database note
